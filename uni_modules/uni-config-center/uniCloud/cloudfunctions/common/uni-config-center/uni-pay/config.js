...
module.exports = {
	...
	"notifyKey":"5FB2CD73C7B53918728417C2659E6D45FB2CD73C7B53918728417C50762E6D4", // 跨云函数通信时的加密密钥，建议手动改下，不要使用默认的密钥，长度保持在64位以上即可
	// 微信支付相关
	"wxpay": {
	...
	"alipay": {
		...
		"native": {
			"appId": "2021004111653191", // 支付宝开放平台下应用的appid
			// 支付宝商户私钥
			"privateKey": "", 
			"appCertPath": path.join(__dirname, 'alipay/appCertPublicKey.crt'), // 支付宝商户公钥路径
			"alipayPublicCertPath": path.join(__dirname, 'alipay/alipayCertPublicKey_RSA2.crt'), // 支付宝公钥路径
